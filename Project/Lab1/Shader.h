...
protected:
private:
	static const unsigned int MAXIMUM_NUM_SHADERS = 3; 
	unsigned int NUM_SHADERS = MAXIMUM_NUM_SHADERS; // number of shaders
	...
	GLuint shaders[MAXIMUM_NUM_SHADERS]; //array of shaders
